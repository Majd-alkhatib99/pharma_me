...
class MedicineItemBuilder extends StatelessWidget {
  const MedicineItemBuilder({super.key, required this.medicineModel,required this.index});
    ...
    return Padding(
      ...
      child: Stack(
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CustomText(
                            text: medicineModel.category!=null?medicineModel.category!.catName!:'?Name',
          ...
          Checkbox(value: cubit.checkBoxValue[index], onChanged: (value)=>cubit.changeCheckBoxState(value!,index),),
        ],
      ),
    );
  },
